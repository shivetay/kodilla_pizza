...
class Booking {
  ...
  //   thisBooking.dom.tableNumber = thisBooking.dom.wrapper.getAttribute(settings.booking.tableIdAttribute);
  //   console.log('table number', thisBooking.dom.tableNumber);
